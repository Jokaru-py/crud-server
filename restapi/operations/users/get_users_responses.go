...
type GetUsersOK struct {
	...
	/*
	  In: Body
	*/
	Payload *models.AllUserResponse `json:"body,omitempty"`
}
...
func (o *GetUsersOK) WithPayload(payload *models.AllUserResponse) *GetUsersOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get users o k response
func (o *GetUsersOK) SetPayload(payload *models.AllUserResponse) {
	o.Payload = payload
}
...
/*GetUsersBadRequest Некорректный запрос
...
/*GetUsersInternalServerError Внутренняя ошибка сервера
