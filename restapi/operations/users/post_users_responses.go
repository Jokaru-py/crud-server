...
type PostUsersOK struct {
	...
	/*
	  In: Body
	*/
	Payload *models.UserUploadResponse `json:"body,omitempty"`
}
...
func (o *PostUsersOK) WithPayload(payload *models.UserUploadResponse) *PostUsersOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the post users o k response
func (o *PostUsersOK) SetPayload(payload *models.UserUploadResponse) {
	o.Payload = payload
}
...
/*PostUsersBadRequest Некорректный запрос
...
/*PostUsersInternalServerError Внутренняя ошибка сервера
